...
namespace Maverick.Json
{
    internal static class Traits<T>
    {
        ...
        public static readonly Boolean IsNullable = Type.IsGenericType && Type.GetGenericTypeDefinition() == typeof( Nullable<> );
        public static readonly Boolean IsReferenceTypeOrNullable = IsReferenceType || IsNullable;
